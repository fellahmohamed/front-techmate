...
export const Navbar = ({ getType }) => {
    ...
    return (
        <nav className="nav-container">
            ...
            {
                roles.find((role) => {
                    return role === "superAdmin" || role === "product management"
                }) &&
            ...
            {
                roles.find((role) => {
                    return role === "superAdmin" || role === "orders management"
                }) &&
                <Link to="/admin/allorders" className="link">
                    <div className={activeLink === 'allusers' ? 'link-container active' : 'link-container'} onClick={handleActiveClick}>
            ...
            <div className={`cat-container ${isDisplay ? "cat-visible" : "cat-hidden"} ${location.pathname !== "/admin/allproducts" ? 'pointer-events-none' : ''}`}  >
